 ...
 */
export const LIGHT_KEYS: ThemeKey[] = ["normal", "newsprint", "candy", "apex", "gloam", "riso", "foundry"];
...
export interface ThemeDef {
  ...
  // Which of the five transcript languages (lib/toolwidget ToolStyle) this
  // theme reads in by default. Applied on pick exactly like crt/swp/glw;
  // HudSettings.toolStyle stays the user override afterwards.
  chat: ToolStyle;
...
const CLAUDE_DEFS: ThemeDef[] = CLAUDE_ACCENTS.map(([key, name, feel, acc]) => ({
  ...
  font: "ui-sans-serif,-apple-system,'Segoe UI',system-ui,sans-serif", prad: "8px", chat: "halo",
  pal: { ...CLAUDE_PAL, acc, "accent-rgb": rgbTriplet(acc) },
}));

export const THEME_DEFS: ThemeDef[] = [
  { key: "aqua", name: "AURORA", feel: "orbital glass · clean signal", filter: "none", ops: [], sw: "#7fe9d8", bg: "rgba(10,26,32,.55)", pbg: "#04090b", crt: true, swp: true, glw: true, canvas: "#060a0a", font: "", prad: "0", chat: "stamp" },
  { key: "green", name: "VIRIDIAN", feel: "buried relay · net-runner", filter: "hue-rotate(-58deg) saturate(1.5)", ops: [["hue", -58], ["sat", 1.5]], sw: "#5fdd8f", bg: "rgba(8,28,16,.5)", pbg: "#040a07", crt: true, swp: true, glw: true, canvas: "#060a0a", font: "", prad: "0", chat: "stamp" },
  { key: "amber", name: "EMBER", feel: "salvage rig · warm static", filter: "hue-rotate(-146deg) saturate(1.7)", ops: [["hue", -146], ["sat", 1.7]], sw: "#e8b04a", bg: "rgba(34,20,4,.5)", pbg: "#0a0703", crt: true, swp: true, glw: true, canvas: "#060a0a", font: "", prad: "0", chat: "stamp" },
  { key: "magenta", name: "NOVA", feel: "neon district · synthwave", filter: "hue-rotate(132deg) saturate(1.6)", ops: [["hue", 132], ["sat", 1.6]], sw: "#ff7ad9", bg: "rgba(28,8,34,.55)", pbg: "#090410", crt: true, swp: true, glw: true, canvas: "#060a0a", font: "", prad: "0", chat: "stamp" },
  ...
  { key: "newsprint", name: "NEWSPRINT", feel: "morning paper · ink & spot colour", filter: "none", ops: [], sw: "#1a1a18", bg: "rgba(210,201,181,.55)", pbg: "#e8e2d3", crt: false, swp: false, glw: false, canvas: "#e8e2d3", font: "Georgia,'Times New Roman',serif", prad: "0", chat: "press", pal: { acc: "#1a1a18", "acc-on": "#f6f4ee", "accent-rgb": "26 26 24", ok: "#2f6b45", warn: "#7b5f10", err: "#b02a2a", "err-hi": "#8f2222", "err-b": "#711b1b", "err-g": "#916d6d", info: "#1f5586", "info-hi": "#18446b", "info-b": "#123350", purple: "#6b4a72", "purple-d": "#5c3f63", "purple-h": "#4d3453", "purple-b": "#3e2a43", "purple-g": "#827187", txb: "#14110c", txh: "#2b2821", tx: "#3a362f", txm: "#49453e", txd: "#56524a", txf: "#5d5950", txl: "#646057", txg: "#7c776d", panel: "#fbf9f3", panel2: "#f2eee2", panel3: "#e9e4d5", canvas: "#e8e2d3", mono: "'Courier New',monospace" } },
  ...
  { key: "blueprint", name: "BLUEPRINT", feel: "drafting table · pencil annotations", filter: "none", ops: [], sw: "#7fb0ff", bg: "rgba(5,10,22,.55)", pbg: "#061024", crt: false, swp: false, glw: false, canvas: "repeating-linear-gradient(0deg,rgba(127,176,255,.06) 0 1px,transparent 1px 26px),repeating-linear-gradient(90deg,rgba(127,176,255,.06) 0 1px,transparent 1px 26px),#06101f", font: "", prad: "0", chat: "wire", pal: { acc: "#7fb0ff", "acc-on": "#04101f", "accent-rgb": "127 176 255", ok: "#5fe0a8", warn: "#ffc861", err: "#ff8a7a", "err-hi": "#ffbdb2", "err-b": "#ffd8d0", "err-g": "#a4675c", info: "#63d7f0", "info-hi": "#9ee7f7", "info-b": "#cdf2fb", purple: "#c4a6ff", "purple-d": "#b18eff", "purple-h": "#d7c2ff", "purple-b": "#e8dcff", "purple-g": "#7a68ab", txb: "#e8f0fc", txh: "#cdd9ee", tx: "#b4c4de", txm: "#93a6c4", txd: "#7b8ead", txf: "#6f84a4", txl: "#677da6", txg: "#32405c", panel: "#081226", panel2: "#060e1c", panel3: "#040912", canvas: "#06101f", mono: "'JetBrains Mono',monospace" } },
  ...
  { key: "void", name: "VOID", feel: "true black · colour only where it means something", filter: "none", ops: [], sw: "#ffffff", bg: "rgba(0,0,0,.55)", pbg: "#000000", crt: false, swp: false, glw: false, canvas: "#000000", font: "system-ui,-apple-system,'Segoe UI',sans-serif", prad: "0", chat: "signal", pal: { acc: "#ffffff", "acc-on": "#000000", "accent-rgb": "255 255 255", ok: "#4ade80", warn: "#fbbf24", err: "#f87171", "err-hi": "#fca5a5", "err-b": "#fecaca", "err-g": "#8a5c5c", info: "#60a5fa", "info-hi": "#93c5fd", "info-b": "#bfdbfe", purple: "#c084fc", "purple-d": "#a855f7", "purple-h": "#d8b4fe", "purple-b": "#e9d5ff", "purple-g": "#6f5b86", txb: "#ffffff", txh: "#ededed", tx: "#d4d4d4", txm: "#b4b4b4", txd: "#9a9a9a", txf: "#8d8d8d", txl: "#828282", txg: "#565656", panel: "#121212", panel2: "#0b0b0b", panel3: "#070707", canvas: "#000000", mono: "'JetBrains Mono',monospace" } },
  ...
  // "go" and "good" are one word here — which is why it sits out COLORFUL in
  // tests/test_light_theme_contrast.py. Neutral ink ladder (the ground is
  // achromatic, so grey ink is honest, unlike a tinted ground); JetBrains
  // voice because a log is set in mono.
  { key: "signal", name: "SIGNAL", feel: "black box · chartreuse go, level inks", filter: "none", ops: [], sw: "#9ade4a", bg: "rgba(10,10,11,.55)", pbg: "#0a0a0b", crt: false, swp: false, glw: false, canvas: "#0a0a0b", font: "'JetBrains Mono',ui-monospace,SFMono-Regular,Menlo,monospace", prad: "0", chat: "signal", pal: { acc: "#9ade4a", "acc-on": "#0c0c0d", "accent-rgb": "154 222 74", ok: "#9ade4a", warn: "#e8b13c", err: "#ff6b5e", "err-hi": "#ff938a", "err-b": "#ffb8b1", "err-g": "#8f5f5a", info: "#7fb8ff", "info-hi": "#a5cdff", "info-b": "#cce2ff", purple: "#a98bff", "purple-d": "#9a79f2", "purple-h": "#bfa3ff", "purple-b": "#d9c9ff", "purple-g": "#6d6383", txb: "#f2f2ee", txh: "#e4e4df", tx: "#dcdcd8", txm: "#a5a5ad", txd: "#8b8b93", txf: "#77777f", txl: "#5a5a60", txg: "#33333a", panel: "#131316", panel2: "#101012", panel3: "#0c0c0d", canvas: "#0a0a0b", mono: "'JetBrains Mono',monospace" } },
  // FOUNDRY is the control plate's own skin off the same sheet (1b): poured-
  // concrete ground, near-black ink, safety orange. Light theme. The sheet
  // drew it on #cfcfc9, but that concrete is too dark for this file's ink
  // ratios — even pure black is 13.4:1 there, under the 14:1 txb floor — so
  // per the standing rule (keep hue, move lightness) the ground is lifted one
  // step to #dcdcd6 and every ink re-solved on it; the orange is the sheet's
  // #e2600d darkened until it reads as text, not paint. prad 0 — a stamped
  // plate has no corners to round. Out of COLORFUL: its warn is a burnt amber
  // ~15° off the orange accent, trade-dress rather than accident.
  { key: "foundry", name: "FOUNDRY", feel: "shop floor · concrete & safety orange", filter: "none", ops: [], sw: "#a34305", bg: "rgba(220,220,214,.55)", pbg: "#dcdcd6", crt: false, swp: false, glw: false, canvas: "#dcdcd6", font: "'Archivo',system-ui,-apple-system,sans-serif", prad: "0", chat: "stamp", pal: { acc: "#a34305", "acc-on": "#ffffff", "accent-rgb": "163 67 5", ok: "#2f6b46", warn: "#845706", err: "#b02a1e", "err-hi": "#9c2318", "err-b": "#851d13", "err-g": "#9e6861", info: "#1d5d8c", "info-hi": "#184f77", "info-b": "#134263", purple: "#7b3ab8", "purple-d": "#6e33a6", "purple-h": "#622d94", "purple-b": "#552682", "purple-g": "#886a9c", txb: "#0d0d0f", txh: "#242529", tx: "#323339", txm: "#42444b", txd: "#4d5057", txf: "#53565e", txl: "#5b5d66", txg: "#73757e", panel: "#eeeee8", panel2: "#e8e8e2", panel3: "#e2e2dc", canvas: "#dcdcd6", mono: "'Space Mono',monospace" } },
];
...
export const FONTS: { key: string; label: string; stack: string }[] = [
  ...
  { key: "spacemono", label: "SPACE MONO", stack: "'Space Mono',ui-monospace,SFMono-Regular,Menlo,monospace" },
  ...
  { key: "archivo", label: "ARCHIVO", stack: "'Archivo',system-ui,-apple-system,sans-serif" },
